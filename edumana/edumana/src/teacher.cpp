...
void teacher::set_top(){
    ...
    subMenu_evaluate->setTitle("成绩管理");
...
void teacher::action_subMenu_select(QMenu *m){
    ...
    select_course->setText("空闲教室");
    reset_make_up->setText("上课教室");
    graduation_topics->setText("教室申请");
    grade_test->setText("实验室申请");
    test->setText("课表查询");
...
void teacher::action_subMenu_evaluate(QMenu *m){
    ...
    teacher_evaluate->setText("修改成绩");
    other_question->setText("查看成绩");
    course_evaluate->setText("登记平时分");
    class_evaluate->setText("登记理论成绩");
