...
static const char qt_meta_stringdata_set[] = {
    "set\0\0on_returnButton_clicked()\0"
    "on_loginButton_clicked()\0"
    "on_exitButton_clicked()\0"
    "on_userPhotoButton_clicked()\0"
};
...
void set::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_userPhotoButton_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData set::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject set::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_set,
      qt_meta_data_set, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &set::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_set))
